...
/// UI002: Flag any `setName()` call whose string argument contains "settings".
/// This is exact because `setName()` is the only way to set a heading in
/// settings panels, and the guideline explicitly forbids the word "settings".
